      ...
      <form className="flex-1 flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <div className="flex items-center gap-2 ml-2">
              ...
              <input type="text" defaultValue="10.00" className="w-16 bg-slate-50 border border-slate-200 rounded px-2 py-1.5 text-xs text-slate-800 focus:outline-none focus:border-sky-500 text-center" />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 text-xs">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <select className="bg-slate-50 border border-slate-200 rounded px-2 py-1 text-slate-800 focus:outline-none focus:border-sky-500 cursor-pointer">
        ...
        <div>
          ...
          <div className="grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-3 items-center text-xs">
            ...
            <input type="text" defaultValue="4445.50" className="bg-slate-50 border border-slate-200 rounded px-3 py-1.5 text-slate-800 focus:outline-none focus:border-sky-500" />
            <span></span>
            
            <span className="font-medium text-slate-500 text-right">SL:</span>
            <input type="text" defaultValue="4444.30" className="bg-slate-50 border border-slate-200 rounded px-3 py-1.5 text-slate-800 focus:outline-none focus:border-sky-500" />
            <span className="text-slate-500">&rarr; (1.2 pips)</span>
            
            <span className="font-medium text-slate-500 text-right">TP:</span>
            <input type="text" defaultValue="4451.30" className="bg-slate-50 border border-slate-200 rounded px-3 py-1.5 text-slate-800 focus:outline-none focus:border-sky-500" />
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-slate-50 transition-colors bg-white">
            <CloudUpload className="size-6 text-sky-400 mb-2" strokeWidth={2} />
        ...
        <div className="mt-auto pt-2">
          <button 
            type="button" 
            className="w-full bg-sky-500 hover:bg-sky-600 text-white font-bold py-3.5 px-4 rounded-xl transition-colors focus:outline-none shadow-md shadow-sky-500/20 flex items-center justify-center gap-2 text-xs tracking-wide"
          >
            <Lock className="size-4" />
            SAVE ACTIVE (RUN POSITION)
          </button>
        </div>
      </form>
    </div>
